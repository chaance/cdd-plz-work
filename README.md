...
- Create two apps on Fly, one for staging and one for production:
  ...
  ```sh
  fly create cdd-plz-work-a34k
  fly create cdd-plz-work-a34k-staging
  ```
...
- Add a `SESSION_SECRET` to your fly app secrets, to do this you can run the following commands:
  ...
  ```sh
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app cdd-plz-work-a34k
  fly secrets set SESSION_SECRET=$(openssl rand -hex 32) --app cdd-plz-work-a34k-staging
  ```

  > **Note:** When creating the staging secret, you may get a warning from the Fly CLI that looks like this:
  >
  > ```
  > WARN app flag 'cdd-plz-work-a34k-staging' does not match app name in config file 'cdd-plz-work-a34k'
  > ```
  >
...
- Create a database for both your staging and production environments. Run the following:
  ...
  ```sh
  fly postgres create --name cdd-plz-work-a34k-db
  fly postgres attach --postgres-app cdd-plz-work-a34k-db --app cdd-plz-work-a34k

  fly postgres create --name cdd-plz-work-a34k-staging-db
  fly postgres attach --postgres-app cdd-plz-work-a34k-staging-db --app cdd-plz-work-a34k-staging
  ```
